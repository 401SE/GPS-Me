...
//        {
//            String s = savedInstanceState.getString("log");
...
//        }
        ...
        if (extras != null)         // Only null on initial install
        {
            String phone_string = extras.getString("MessageNumber");

            if (extras.getString("MessageNumber" ) != null )        // There after no longer null.
            {
...
//            }
            ...
            Toast.makeText(this, "CheckSelfPermission", Toast.LENGTH_SHORT).show();
...
//  157
    ...
    class Thread3 implements Runnable {
        ...
        public void run()
        {
            ...
            //else              new Thread(new Thread2()).start();
        }
    }
...
//        savedInstanceState.putString("log", messageLog_TextView.getText().toString() );
//    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString("log", messageLog_TextView.getText().toString() );
    }
}
